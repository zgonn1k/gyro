# О проекте
Наш проект нацелен на получение и обработку данных с волоконно-оптического гироскопа для создания фильтров, осуществляющих подавление шумов, которые возникают при работе гироскопа.
