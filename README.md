# О проекте
При разработке электронных устройств зачастую требуется проводить анализ данных, с которыми работает система. Например, данные, приходящие с датчиков, могут нести с собой шумы, помехи, искажения. Для дальнейшего проектирования и расчета цифрового фильтра необходимо установить множество параметров сигнала, приходящего с устройства.  

Для решения подобных задач нами разрабатывается приложение __Veryslot 2__. Модульная архитектура __Veryslot 2__ позволяет гибко настраивать работу приложения под заданные требования путем конфигурации необходимых [модулей](#добавление-модулей).

В качестве демонстрации работы __Veryslot 2__ далее представлен процесс получения и обработки данных с волоконно-оптического гироскопа для создания фильтров, осуществляющих подавление шумов, которые возникают при работе гироскопа.
