...
# Требования для запуска файла-скрипта 
...
2. __*Jupiter Notebook*__

Для установки в командной строке нужен ввести следующую команду: 
``` cmd
  pip install notebook
```
Для запуска блокнота необходимо ввести следующую команду:
``` cmd
  jupyter notebook
```
